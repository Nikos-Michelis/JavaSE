...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // create the keystore and the keypair
        ...
        // get the SSLServerSocketFactory from context
        ...
        try (SSLServerSocket server = (SSLServerSocket)
            ...
            System.out.println(sockClient.getSession().getCipherSuite());
            System.out.println(Arrays.toString(sockClient.getSession().getLocalCertificates()));
