...
public class User implements Serializable {
    ...
    static {
        try {
            FileHandler handlerTarget = new FileHandler("logs.log");
            handlerTarget.setFormatter(new SimpleFormatter());
            MemoryHandler memoryHandler = new MemoryHandler(handlerTarget, 2, Level.FINEST);
